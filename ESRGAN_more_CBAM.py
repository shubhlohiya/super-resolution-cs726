...
def build_discriminator():
    ...
    for i in range(4):
      ...
      x = CBAM(64,4)(x,x.shape[1],x.shape[2],x.shape[3])
      y = Conv2D(64 , kernel_size = 6 , strides = 1 , padding = 'same')(y)
      y = CBAM(64,4)(y,y.shape[1],y.shape[2],y.shape[3])
      x = LeakyReLU()(x)
      y = LeakyReLU()(y)
